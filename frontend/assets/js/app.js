...
import { check, rescue, fetchShareQrSvg, ApiError } from './api.js?v=stage5-tabs-v8';
...
import { normalizeDetective, RISK_META, offersRescueGuidance, offersShareCard } from './result-model.js?v=stage5-tabs-v8';
import {
  buildShareCardModel,
  decodeQrModules,
  drawShareCard,
  safeFileName,
} from './share-card.js?v=stage5-tabs-v8';
