...
- Cô tâm lý lỗi không che kết quả Thám tử; API vẫn trả 200 với trạng thái độc lập.
- Không giới hạn số lượt kiểm tra theo phiên; timeout và retry hữu hạn vẫn bảo vệ mỗi request.
